...
export function About() {
  ...
  return (
    <section
      id="about"
      className="bg-gradient-to-b from-white to-orange-50/30 py-20 md:py-32"
    >
      <div className="container mx-auto px-4">
        ...
        >
          <div className="group relative overflow-hidden rounded-3xl shadow-lg transition-all hover:scale-105 hover:shadow-2xl">
            <Image
              src="/lop-hoc-hien-dai.jpg"
              alt="trang chủ lớp học hiện đại"
              width={400}
              height={300}
          ...
          <div className="group relative overflow-hidden rounded-3xl shadow-lg transition-all hover:scale-105 hover:shadow-2xl">
            <Image
              src="/hoc-vien-tich-cuc.jpg"
              alt="Trang chủ học viên tích cực"
              width={400}
              height={300}
              className="h-72 w-full object-cover transition-transform duration-500 group-hover:scale-110"
            />
          ...
          <div className="group relative overflow-hidden rounded-3xl shadow-lg transition-all hover:scale-105 hover:shadow-2xl">
            <Image
              src="/giang-vien-chuyen-nghiep.jpg"
              alt="Giáo viên GNP"
              width={400}
              height={300}
              className="h-72 w-full object-cover transition-transform duration-500 group-hover:scale-110"
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
            <div className="absolute bottom-4 left-4 translate-y-4 text-white opacity-0 transition-all group-hover:translate-y-0 group-hover:opacity-100">
              <p className="font-semibold">Giáo viên chuyên nghiệp</p>
            </div>
          </div>
        </div>
          ...
          <Card className="border-0 bg-gradient-to-br from-primary/5 to-secondary/5 shadow-xl">
            <CardContent className="p-8 md:p-12">
              ...
              <p className="mb-4 text-lg leading-relaxed text-foreground/80">
                GNP English Academy được thành lập với sứ mệnh cung cấp nền tảng
                giáo dục tiếng Anh toàn diện, hiện đại và hiệu quả cho mọi đối
                tượng học viên tại Việt Nam.
              </p>
              <p className="text-lg leading-relaxed text-foreground/80">
                Chúng tôi hướng đến việc trở thành trung tâm tiếng Anh hàng đầu,
                nơi học viên không chỉ học ngôn ngữ mà còn phát triển tư duy, kỹ
                năng và tự tin để vươn ra thế giới.
              </p>
            </CardContent>
          </Card>
        </div>
